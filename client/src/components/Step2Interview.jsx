...
import interviewImage from '../assets/AI_INTERVIEW.png'
...
function Step2Interview({ interviewData, onFinish }) {
  ...
  const videoSource = voiceGender === "male" ? "/videos/male-ai.mp4" : "/videos/female-ai.mp4";
  ...
  const submitAnswer = async () => {
    ...
    try {
      const result = await axios.post(
        `${ServerURL}/api/interview/submit-answer/${interviewId}/${currentIndex}`,
        {
        interviewId,
...
setIsSubmitting(false)
  ...
  const finishInterview = async () => {
    ...
    setIsMicOn(false)
    try {
      const result = await axios.post(`${ServerURL}/api/interview/finish-interview/${interviewId}`, { interviewId }, {withCredentials:true})
