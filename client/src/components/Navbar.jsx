    ...
    <div className= 'bg-[#f3f3f3] flex justify-center px-4 pt-6'>
      ...
      className='w-full max-w-6xl bg-white rounded-[24px] shadow-sm border border-gray-200 px-8 py-4 flex justify-between items-center'>
        ...
        <div className='flex items-center gap-3 cursor-pointer'>
          ...
          <h1 className='font-semibold text-lg'>PrepBot</h1>
        </div>
        ...
        <div className='flex items-center gap-4'>
          ...
          <div className='relative'>
            <button
              ...
              className='w-9 h-9 rounded-full bg-black text-white flex items-center justify-center font-semibold text-sm'
            >
              {userData?.name
